...
def findFirst(Tris):
    ...
    curry = 100
    pasty = 100
    # For every triangle in the copy list, check to find the triangle with the least number of valid adjacent triangles,
    # then return that value. For only the value of one adjacent triangle, if found the loop breaks before getting
    # through the rest of the list. If no triangles with 1 adjacent can be found, the program checks for available
    # triangles with 2 adjacent. It then checks to see if the adjacent to that triangle has 1, 2, or 3 adjacent and
    # returns the first triangle to have the lowest number of adjacent triangles of the current adjacent triangle.
    # The program follows the same process for 3 adjacent if no triangles with 2 adjacent can be found.
    # This follows the idea of following the path of triangles that have the minimum of adjacent triangles
    # with 2 levels of checking.
    for p in Tris:
        if ((len(p.adjTris) == 1) and (p.adjTris[0].nextTri == None)):
            ...
            if (currx < pastx):
                first2 = p
                pastx = currx
        elif ((len(p.adjTris) == 3) and (
                (p.adjTris[0].nextTri == None) or (p.adjTris[1].nextTri == None) or (p.adjTris[2].nextTri == None))):
            if ((p.adjTris[0].nextTri == None) and (p.adjTris[1].nextTri == None) and (p.adjTris[2].nextTri == None)):
                curry = 3
            elif (((p.adjTris[0].nextTri == None) and (p.adjTris[1].nextTri == None)) or (
                    (p.adjTris[1].nextTri == None) and (p.adjTris[2].nextTri == None)) or (
                          (p.adjTris[0].nextTri == None) and (p.adjTris[2].nextTri == None))):
                curry = 2
            else:
                curry = 1
            if (curry < pasty):
    ...
    if (length == 3):
        ...
        if (tri0.nextTri == None):
            if ((len(tri0.adjTris) == 1) and (tri0.adjTris[0].nextTri == None)):
                x1 = 1
            elif ((len(tri0.adjTris) == 2) and (
                    (tri0.adjTris[0].nextTri == None) or (tri0.adjTris[1].nextTri == None))):
                if ((tri0.adjTris[0].nextTri == None) and (tri0.adjTris[1].nextTri == None)):
                    x1 = 2
                else:
                    x1 = 1
            elif ((len(tri0.adjTris) == 3) and (
                    (tri0.adjTris[0].nextTri == None) or (tri0.adjTris[1].nextTri == None) or (
                    tri0.adjTris[2].nextTri == None))):
                if ((tri0.adjTris[0].nextTri == None) and (tri0.adjTris[1].nextTri == None) and (
                        tri0.adjTris[2].nextTri == None)):
                    x1 = 3
                elif (((tri0.adjTris[0].nextTri == None) and (tri0.adjTris[1].nextTri == None)) or (
                        (tri0.adjTris[1].nextTri == None) and (tri0.adjTris[2].nextTri == None)) or (
                              (tri0.adjTris[2].nextTri == None) and (tri0.adjTris[0].nextTri == None))):
                    x1 = 2
                else:
                    x1 = 1
        ...
        if (tri1.nextTri == None):
            if ((len(tri1.adjTris) == 1) and (tri1.adjTris[0].nextTri == None)):
                x2 = 1
            elif ((len(tri1.adjTris) == 2) and (
                    (tri1.adjTris[0].nextTri == None) or (tri1.adjTris[1].nextTri == None))):
                if ((tri1.adjTris[0].nextTri == None) and (tri1.adjTris[1].nextTri == None)):
                    x2 = 2
                else:
                    x2 = 1
            elif ((len(tri1.adjTris) == 3) and (
                    (tri1.adjTris[0].nextTri == None) or (tri1.adjTris[1].nextTri == None) or (
                    tri1.adjTris[2].nextTri == None))):
                if ((tri1.adjTris[0].nextTri == None) and (tri1.adjTris[1].nextTri == None) and (
                        tri1.adjTris[2].nextTri == None)):
                    x2 = 3
                elif (((tri1.adjTris[0].nextTri == None) and (tri1.adjTris[1].nextTri == None)) or (
                        (tri1.adjTris[1].nextTri == None) and (tri1.adjTris[2].nextTri == None)) or (
                              (tri1.adjTris[2].nextTri == None) and (tri1.adjTris[0].nextTri == None))):
                    x2 = 2
                else:
                    x2 = 1
        ...
        if (tri2.nextTri == None):
            if ((len(tri2.adjTris) == 1) and (tri2.adjTris[0].nextTri == None)):
                x3 = 1
            elif ((len(tri2.adjTris) == 2) and (
                    (tri2.adjTris[0].nextTri == None) or (tri2.adjTris[1].nextTri == None))):
                if ((tri2.adjTris[0].nextTri == None) and (tri2.adjTris[1].nextTri == None)):
                    x3 = 2
                else:
                    x3 = 1
            elif ((len(tri2.adjTris) == 3) and (
                    (tri2.adjTris[0].nextTri == None) or (tri2.adjTris[1].nextTri == None) or (
                    tri2.adjTris[2].nextTri == None))):
                if ((tri2.adjTris[0].nextTri == None) and (tri2.adjTris[1].nextTri == None) and (
                        tri2.adjTris[2].nextTri == None)):
                    x3 = 3
                elif (((tri2.adjTris[0].nextTri == None) and (tri2.adjTris[1].nextTri == None)) or (
                        (tri2.adjTris[1].nextTri == None) and (tri2.adjTris[2].nextTri == None)) or (
                              (tri2.adjTris[2].nextTri == None) and (tri2.adjTris[0].nextTri == None))):
                    x3 = 2
                else:
                    x3 = 1
...
def buildTristrips(triangles):
    ...
    while 1:
        ...
        while 1:
            ...
            if ((length == 3) and ((p.adjTris[0].nextTri != None) and (p.adjTris[1].nextTri != None) and (
                    p.adjTris[2].nextTri != None))):
                break
